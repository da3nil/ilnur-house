...
{{--                    <span class="icon-bar"></span>--}}
{{--                </button>--}}
                <a class="navbar-brand" href="#">Приятного рабочего дня!!!</a>
            </div>
                ...
                <div class="col-md-9 header-left">
                    <div class="top-nav">
                        <ul class="memenu skyblue">
                            ...
                            <li class="@if(Request::route()->getName() === "category.index") active @endif"><a href="{{ route('category.index') }}">Справочник</a></li>
                        </ul>
                    </div>
                    <div class="clearfix"></div>
                </div>
        ...
        <div class="container">
            <div class="footer-top">
                ...
                <div class="col-md-12 " style="text-align: center;">
                    <p style="font-family: 'Bree-Serif-k', sans-serif">© 2021 Басыров Ильнур Зиннурович</p>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
